    ...
    svc.postingService.post(
      {
        ...
        lines: [
          { accountId: env.accounts.bankId, debitAmount: d(SEED_REVENUE), creditAmount: d(0) },
          { accountId: env.accounts.revId,  debitAmount: d(0), creditAmount: d(SEED_REVENUE) },
        ],
      },
      tx as never,
    ),
    ...
    svc.postingService.post(
      {
        ...
        createdBy:          env.identity.userId,
        lines: [
          { accountId: env.accounts.expId,  debitAmount: d(SEED_EXPENSE), creditAmount: d(0) },
          { accountId: env.accounts.bankId, debitAmount: d(0), creditAmount: d(SEED_EXPENSE) },
        ],
      },
      tx as never,
    ),
    ...
    svc.postingService.post(
      {
        ...
        createdBy:          env.identity.userId,
        lines: [
          { accountId: env.accounts.expId, debitAmount: d(500), creditAmount: d(0) },
          { accountId: env.accounts.revId, debitAmount: d(0),   creditAmount: d(500) },
        ],
      },
      tx as never,
    ),
    ...
    svc.postingService.post(
      {
        ...
        createdBy:          env.identity.userId,
        lines: [
          { accountId: env.accounts.bankId, debitAmount: d(SEED_PROJ_REV), creditAmount: d(0), projectId: projectAId },
          { accountId: env.accounts.revId,  debitAmount: d(0), creditAmount: d(SEED_PROJ_REV), projectId: projectAId },
        ],
      },
      tx as never,
    ),
    ...
    svc.postingService.post(
      {
        ...
        createdBy:          env.identity.userId,
        lines: [
          { accountId: env.accounts.bankId, debitAmount: d(SEED_DEPT_REV), creditAmount: d(0), departmentId: deptAId },
          { accountId: env.accounts.revId,  debitAmount: d(0), creditAmount: d(SEED_DEPT_REV), departmentId: deptAId },
        ],
      },
      tx as never,
    ),
