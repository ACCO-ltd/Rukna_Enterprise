...
COOKIE_SAMESITE=lax
PLATFORM_DATABASE_URL=postgresql://erp_user:$DB_PASSWORD@rukna_postgres:5432/rukna_platform
DATABASE_URL=postgresql://erp_user:$DB_PASSWORD@rukna_postgres:5432/rukna_acco
