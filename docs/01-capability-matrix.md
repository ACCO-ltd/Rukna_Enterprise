...
| Variations / Change Orders | ✓ | (UI: partial) | BACKEND | ADR-026 P1–P5 all built & merged: `VariationOrder` aggregate + guarded lifecycle (P1); scope-into-BOQ + explicit contract-baseline repoint (P2); certified/invoiced traced by VO — reads only (P3); Extension-of-Time (P4); the two at-risk commencement routes 7A/7B (P5). UI: P6 tab shipped (raise/approve/EoT + four value figures); the P3 trace + P5 at-risk UI remain. |
